...
ToolBox = guiCreateWindow(NormalX, NormalY, 192, 387, "Marshmello's Col Editor", false)
guiWindowSetSizable(ToolBox, false)
guiSetVisible(ToolBox, false)
guiSetAlpha(ToolBox, 1.00)

Create = guiCreateButton(9, 26, 173, 40, "Create >", false, ToolBox)
Delete = guiCreateButton(9, 76, 173, 40, "Delete >", false, ToolBox)
Delete_All = guiCreateButton(9, 126, 173, 40, "Delete All", false, ToolBox)
Code = guiCreateButton(9, 176, 173, 40, "Code", false, ToolBox)
Element_Info = guiCreateButton(9, 226, 173, 40, "Current Shape Info", false, ToolBox)
Select = guiCreateButton(9, 276, 173, 40, "Select >", false, ToolBox)
Close = guiCreateButton(9, 326, 173, 40, "Close", false, ToolBox)
